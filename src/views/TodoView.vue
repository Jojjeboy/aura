      ...
      <div v-else class="grid gap-4">
        <div
          ...
          :class="[
            ...
            expandedTodoId === todo.id ? 'shadow-glow ring-1 ring-aura-accent/30 scale-[1.02] z-10' : 'hover:shadow-md hover:scale-[1.01]'
          ]"
        >
          <div class="flex gap-4 items-start">
            ...
            <div class="flex-1 min-w-0">
              ...
              >
                ...
                <div class="mt-5 pt-4 border-t border-slate-100 dark:border-slate-700/50 flex justify-between items-end">
      ...
      <div class="relative bg-white dark:bg-aura-card-dark rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200">
        <div class="p-6 space-y-6">
          ...
          <div class="flex gap-3 pt-2">
             ...
             >{{ editingId ? $t('update_task') : $t('create_task') }}</button>
          </div>
        </div>
      </div>
    </div>
